...
def plot_metrics_bar_chart(group_index, experiment_index, metric_key, metric_name, figsize=(6, 6), font_size=12):
...
if __name__ == "__main__":
    ...
    metric_key = 'FDE-AVE'  # 选择的指标键
    metric_name = r'$\text{FDE}_{\text{Ave}}$/m'
