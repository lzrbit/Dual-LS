...
if __name__ == "__main__":
    # metric_key = 'averaged_FDE'  # 选择的指标键
    # metric_name = 'FDE-AVG (m)'  # Y轴标签名称

    # metric_key = 'averaged_MR'  # 选择的指标键
    # metric_name = 'MR-AVG (%)'  # Y轴标签名称

    # metric_key = 'FDE_BWT'  # 选择的指标键
    # metric_name = 'FDE-BWT (m)'  # Y轴标签名称

    metric_key = 'MR_BWT'  # 选择的指标键
    metric_name = 'MR-BWT/%'  # Y轴标签名称
